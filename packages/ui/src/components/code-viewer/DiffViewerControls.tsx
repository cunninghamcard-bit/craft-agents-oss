  ...
  return (
    <div className={cn('flex items-center gap-1.5', className)}>
      ...
      <button
        ...
        className="cursor-pointer p-1.5 rounded-[6px] bg-background border border-border opacity-70 hover:opacity-100 transition-opacity"
      ...
      <button
        ...
        className={cn(
          'cursor-pointer p-1.5 rounded-[6px] bg-background border border-border transition-opacity',
