...
function LoadingBubble() {
  return (
    <div className="h-16 w-16 rounded-lg bg-background border border-border flex items-center justify-center shrink-0">
  ...
  return (
    <div className="relative group shrink-0 select-none">
      ...
      {isImage ? (
        ...
        <div className="h-16 w-16 rounded-lg overflow-hidden bg-background border border-border">
          {imageSrc ? (
        ...
        <div className="h-16 flex items-center gap-2.5 rounded-lg bg-muted border border-border pl-1.5 pr-3">
          {/* A4-like preview */}
          <div className="h-12 w-9 rounded-md overflow-hidden bg-background border border-border flex items-center justify-center shrink-0">
            {hasThumbnail ? (
              <img
